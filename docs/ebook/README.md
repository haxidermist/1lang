...
**[Read the HTML version in your browser →](index.html)**

Beautiful, browser-readable format with:
...
Visit the hosted version: **[https://haxidermist.github.io/1lang/ebook/](https://haxidermist.github.io/1lang/ebook/)**
